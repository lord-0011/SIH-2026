...
4. **CONFIRMED**: realized-outcome count — total 289 project completions observed across the 11 modern months' "Completed Projects During Month" tables (sizes our realized validation set).
