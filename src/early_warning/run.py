"""Stage: early_warning — see docs/steps/ for the spec that governs this stage.
...
log = get_logger("early_warning")


def run(config: dict | None = None):
    raise NotImplementedError(
        "early_warning not implemented. Follow docs/steps/ for 'early_warning' before coding, "
